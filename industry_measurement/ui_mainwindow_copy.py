...
class UiMainWindow(QMainWindow):
    ...
    def _setup_ui(self):
        ...
        self.image_frame.setMaximumWidth(1280)          # ★ 锁死最大宽度
        self.image_frame.setSizePolicy(
            QSizePolicy(QSizePolicy.Maximum, QSizePolicy.Preferred))  # 水平方向不再扩展
        ...
        self.image_label.setScaledContents(False)        # ★ 图缩放到标签尺寸
        self.image_label.setSizePolicy(
            QSizePolicy(QSizePolicy.Ignored, QSizePolicy.Preferred))  # ★ 水平 sizeHint 忽略
